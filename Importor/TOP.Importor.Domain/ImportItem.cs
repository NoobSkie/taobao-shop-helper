...
namespace TOP.Importor.Domain
{
    ...
    /// 导入宝贝项
    /// </summary>
    [DbTable(DbTableName = "ImportItem", DbObjectType = DbObjectType.Table)]
    public class ImportItem : DbEntity
    {
        /// <summary>
        /// 操作用户Id
        /// </summary>
        ...
        /// 所属导入组Id
        /// </summary>
        [DbField(DbFieldName = "ItsImportGroupId", DbFieldType = DbDataType.UNIQUEIDENTIFIER, IsNotNull = true)]
