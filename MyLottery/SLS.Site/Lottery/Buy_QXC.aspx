<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buy_QXC.aspx.cs" Inherits="SLS.Site.Lottery.Buy_QXC" %>
...
<head id="Head1" runat="server">
    ...
    <script src="~/Home/Room/JavaScript/buy_QXC.js" type="text/javascript"></script>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px;'>
                                    ...
                                    <input type='radio' name='playType' id='playType302' value='302' onclick='clickPlayType(this.value)' />复式
                                </td>
                            </tr>
                        </tbody>
                        <tr>
