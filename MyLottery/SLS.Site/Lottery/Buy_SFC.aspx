<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buy_SFC.aspx.cs" Inherits="SLS.Site.Lottery.Buy_SFC" %>
...
<head id="Head1" runat="server">
    ...
    <link href="~/Home/Room/Style/Buy_ZC.css" rel="stylesheet" type="text/css" />

    <script src="~/Home/Room/JavaScript/Public.js" type="text/javascript"></script>

    <script src="~/Home/Room/JavaScript/buy_SFC.js" type="text/javascript"></script>
            ...
            <div id="cz_center">
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center;">
                        <img id="LotteryImg" src="../Home/Room/Images/logo_1.jpg" alt="胜负彩" width="105" height="108" />
                    </div>
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/SSQ/SSQ_CGXMB.aspx") %>" target="_blank">胜负彩走势图</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/1-0-0.aspx") %>" target="_blank">胜负彩中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px;'>
                                    <input type='radio' name='playType' id='playType101' value='101' checked='checked'
                                        onclick='clickPlayType(this.value)' />单式
                                    <input type='radio' name='playType' id='playType102' value='102' onclick='clickPlayType(this.value)' />复式
                                    <input type='radio' name='playType' id='playType1011' value='1011' checked='checked'
                                        onclick='clickPlayType(this.value)' />单式预投
                                    <input type='radio' name='playType' id='playType1022' value='1022' onclick='clickPlayType(this.value)' />复式预投
                                </td>
                            </tr>
                        </tbody>
                        <tr id="trXH">
            ...
            <div id="cz_right">
                ...
                <div style="width: 218px; background-image: url(../Home/Room/Images/title_bg_blue.jpg);
                    ...
                    <div style="float: left; width: 60px; margin-top: 7px; text-align: right;" class="hui12">
                        ...
                        <span style="cursor: pointer" onclick="BindZCExpertList(1);">
                            <img src='../Home/Room/Images/page_previous.gif' width='9' height='8' alt="" /></span><span
                                style="padding-left: 10px; cursor: pointer" onclick="BindZCExpertList(2);"><img src='../Home/Room/Images/page_next.gif'
                                    width='9' alt="" height='8' /></span> <span style="cursor: pointer" onclick="BindZCExpertList(3);">
                ...
                <div id="tbNews" style="width: 218px; border: solid 1px #BCD2E9; border-top: none;
                    ...
                    <br />
                    <img src='../Home/Room/Images/londing.gif' style="position: relative; left: 15%;"
                        alt="" />
                    <br />
                    <br />
                    <br />
                ...
                <div style="width: 218px; background-color: #6699CC; border: solid 1px #BCD2E9;">
                    ...
                    <div style="float: right; width: 60px; line-height: 28px; text-align: right;" class="hui12">
                        <a href="javascript:;" onclick="newCoBuy(<%=LotteryID %>,<%=Number %>);showSameHeight();">
                            更多&gt;&gt;</a>
                    </div>
                </div>
                ...
                <div style="margin-top: 10px; margin-bottom: 10px;">
                    <img src="../Home/Room/Images/ad_250_80.gif" width="220" height="80" alt="时时乐代购/合买"
                        border="0" />
                </div>
                <!-- 中奖排行榜 开始-->
