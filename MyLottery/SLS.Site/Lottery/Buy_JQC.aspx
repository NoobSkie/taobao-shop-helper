<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buy_JQC.aspx.cs" Inherits="SLS.Site.Lottery.Buy_JQC" %>
...
<head id="Head1" runat="server">
    ...
    <script src="~/Home/Room/JavaScript/buy_JQC.js" type="text/javascript"></script>
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/SSQ/SSQ_CGXMB.aspx") %>" target="_blank">四场进球彩走势图</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px;'>
                                    ...
                                    <input type='radio' name='playType' id='playType2011' value='2011' checked='checked'
