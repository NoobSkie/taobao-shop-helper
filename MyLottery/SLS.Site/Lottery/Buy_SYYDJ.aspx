<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buy_SYYDJ.aspx.cs" Inherits="SLS.Site.Lottery.Buy_SYYDJ" %>
...
<head id="Head1" runat="server">
    ...
    <link href="~/Home/Room/Style/Buy_SYYDJ.css" rel="stylesheet" type="text/css" />
    ...
    <script src="~/Home/Room/JavaScript/buy_SYYDJ.js" type="text/javascript"></script>
            ...
            <div id="cz_center">
               ...
               <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                ...
                <div id="TabMenu" style="margin-top: 15px; border-bottom: #FF6600 2px solid; text-align: center;
                    ...
                    <div class="whiteMenu" onclick="newCoBuy(62);showSameHeight();">
                        参与合买</div>
                    <div style="float: left; width: 2px;">
                    </div>
