<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buy_LCBQC.aspx.cs" Inherits="SLS.Site.Lottery.Buy_LCBQC" %>
...
<head id="Head1" runat="server">
    ...
    <script src="~/Home/Room/JavaScript/buy_LCBQC.js" type="text/javascript"></script>
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/SSQ/SSQ_CGXMB.aspx") %>" target="_blank">六场半全场走势图</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" background="../Home/Room/Images/ssq_qh_bg.jpg">
                        <tr>
                            ...
                            <td width="63" align="center" class="blue12">
                                <a href="javascript:;" id="hrefRJC" onclick="return ClickHMTJ(this)">六场进球</a>
                            </td>
                            <td width="1">
                                &nbsp;
                            </td>
