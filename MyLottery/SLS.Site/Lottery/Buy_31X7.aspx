<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buy_31X7.aspx.cs" Inherits="SLS.Site.Lottery.Buy_31X7" %>
...
<head id="Head1" runat="server">
    ...
    <meta name="keywords" content="31选7选号投注、31选7合买、31选7玩法介绍" />
    <meta name="description" content="<%=_Site.Name %>提供31选7选号投注、合买、玩法介绍等服务。" />
    ...
    <script src="~/Home/Room/JavaScript/buy_31X7.js" type="text/javascript"></script>
            ...
            <div id="cz_center">
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center; vertical-align: middle;
                        ...
                        <img id="LotteryImg" src="../Home/Room/Images/logo_65.jpg" alt="31选7" width="105"
                            height="108" />
                    </div>
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/Index.htm") %>" target="_blank">31选7走势图</a>&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/65-0-0.aspx") %>" target="_blank">31选7中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px;'>
                                    <input type='radio' name='playType' id='playType6501' value='6501' checked='checked'
                                        onclick='clickPlayType(this.value)' />单式
                                    <input type='radio' name='playType' id='playType6502' value='6502' onclick='clickPlayType(this.value)' />复式
                                </td>
                            </tr>
                        </tbody>
                        <tr>
                ...
                <div style="width: 218px; border: solid 1px #BCD2E9; border-top: none; margin-bottom: 10px;">
                    <div style="text-align: center; padding: 15px 5px 10px 5px;">
                        <div id="divPlayIntroduce" style="background-image: url('../Home/Room/Images/zfb_playIntroduce.jpg');
                            ...
                            <a href="../Help/play_65.aspx" target="_blank" style="text-decoration: none; cursor: hand;">
