<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buy_SSC.aspx.cs" Inherits="SLS.Site.Lottery.Buy_SSC" %>
...
<head id="Head1" runat="server">
    ...
    <link href="~/Home/Room/Style/Buy_SSC.css" rel="stylesheet" type="text/css" />
    ...
    <script src="~/Home/Room/JavaScript/buy_JXSSC.js" type="text/javascript"></script>
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 80%; margin-top: 6px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/JXSSC/SSC_5X_ZHFB.aspx") %>" target="_blank">
                                时时彩走势图</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="<%= ResolveUrl("~/WinQuery/61-0-0.aspx") %>"
                                    target="_blank">时时彩中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                                ...
                                <td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px; padding-top: 5px;'>
                                    <table width='100%' cellpadding='0' border='0' cellspacing='0' style='text-align: center;
                                        ...
                                        <tr>
                                            ...
                                            <td class='msplay' onclick='clickPlayClass(0,this);showSameHeight();SelectXing(0)'
                                                onmouseover='mOver(this,1)' onmouseout='mOver(this,2)'>
                                                五星
                                            </td>
                                            <td width='1'>
                                            </td>
                                            <td class='nsplay' onclick='clickPlayClass(1,this);showSameHeight();SelectXing(1)'
                                                onmouseover='mOver(this,1)' onmouseout='mOver(this,2)'>
                                                四星
                                            </td>
                                            <td width='1'>
                                            ...
                                            <td class='nsplay' onclick='clickPlayClass(2,this);showSameHeight();SelectXing(2)'
                                                ...
                                                三星<sup>
                                                    ...
                                                    <img src="../Home/Room/images/1672_hot-dserewr23.gif" />
                                                    </div>
                                                </sup>
                                            </td>
                                            <td width='1'>
