...
public partial class Lottery_Buy_PL5 : RoomPageBase, IRequiresSessionState
{
    public string DZ = "";
    ...
    private void SaveDataForAliBuy()
    {
        ...
        JavaScript.Alert(this.Page, "您的账户余额不足，请先充值，谢谢。", "../Home/Room/OnlinePay/Default.aspx/Send.aspx?BuyID=" + num8.ToString());
    }
