<%@ page language="C#" autoeventwireup="true" CodeFile="~/Lottery/Buy_SSQ.aspx.cs" inherits="Lottery_Buy_SSQ" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    <title>双色球：2元赢取￥1500万-双色球选号投注、合买、玩法介绍－<%=_Site.Name %></title>
    ...
    <script src="../Home/Room/JavaScript/buy_SSQ.js" type="text/javascript"></script>
    ...
    <div id="content">
        ...
        <div id="menu_right">
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/SSQ/SSQ_CGXMB.aspx") %>" target="_blank">双色球走势图</a>&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/5-0-0.aspx") %>" target="_blank">双色球中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
            ...
            <div id="cz_right">
                ...
                <table width="220" id="tdNumber" runat="server"  border="0" cellspacing="1"
                ...
                <div style="width: 218px; border: solid 1px #BCD2E9; border-top: none; margin-bottom: 10px;">
                    <div style="text-align: center; padding: 15px 5px 10px 5px;">
                        <div id="divPlayIntroduce" style="background-image: url('../Home/Room/Images/zfb_playIntroduce.jpg');
                            ...
                            <a href="../Help/play_5.aspx" target="_blank" style="text-decoration: none; cursor: hand;">
