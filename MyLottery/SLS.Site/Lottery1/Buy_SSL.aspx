<%@ page language="C#" autoeventwireup="true" CodeFile="~/Lottery/Buy_SSL.aspx.cs" inherits="Lottery_Buy_SSL" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../Home/Room/Buy_SSL.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" language="javascript" src="../Home/Room/JavaScript/Public.js"></script>
    <script src="../Home/Room/JavaScript/buy_SSL.js" type="text/javascript"></script>
...
<body onload="showSameHeight();">
 ...
 <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                ...
                <div id="TabMenu" style="margin-top: 15px; border-bottom: #FF6600 2px solid; text-align: center;
                    ...
                    <div class="whiteMenu" onclick="newCoBuy(29);showSameHeight();">
                        参与合买</div>
                    <div style="float: left; width: 2px;">
                    </div>
            ...
            <div id="cz_right">
                ...
                <div style="margin-top: 10px; margin-bottom: 10px;">
                        ...
                        <img src="../Home/Room/Images/ad_250_80.gif" alt="时时乐代购/合买" width="220" height="80" border="0" />
                </div>
                 <!-- 中奖排行榜 开始-->
