<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserMyIcaile.ascx.cs" Inherits="SLS.Site.Home.Room.UserControls.UserMyIcaile" %>
<link href="~/Home/Style/css.css" rel="stylesheet" type="text/css" />
<link href="~/Home/Style/UserMyIcaileStyle.css" rel="stylesheet" type="text/css" />
