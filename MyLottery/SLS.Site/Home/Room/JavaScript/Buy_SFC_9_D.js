...
function GetAddone_callback(response) {
    ...
    if (response == null || response.value == null) {
        ...
        time_GetAddone = setTimeout("Lottery_Buy_SFC_9_D.GetAddone(" + currentLotteryID + "," + currentLotteryID + ",GetAddone_callback);", 2000);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SFC_9_D.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
