...
namespace com.yeepay.bank
{
	...
	public abstract class Buy
	{
      ...
      // 交易的请求地址
      private static string nodeAuthorizationURL = ConfigurationSettings.AppSettings["authorizationURL"];

      // 交易的请求地址
      private static string queryRefundReqURL = ConfigurationSettings.AppSettings["queryRefundReqURL"];

      // 商户编号
      private static string merchantId = ConfigurationSettings.AppSettings["merhantId"];

      // 商户密钥
      private static string keyValue = ConfigurationSettings.AppSettings["keyValue"];
