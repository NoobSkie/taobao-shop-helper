...
namespace TextHP
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("请输入代理商账号：");
            accountN.UserName=Console.ReadLine();
            Console.Write("请输入代理商密码：");
            ...
            Console.Write("请输入玩法名称(如：双色球、15选5、3D、七乐彩、6+1、天天彩4、时时乐)：");
            ...
            Console.Write("要投注的彩票号码(测试时，每张彩票一注)：");
            ticketOne.AnteCodes = Console.ReadLine();

            UserProfile user = new UserProfile();
            Console.Write("彩票用户名：");
            user.UserName=Console.ReadLine();
            Console.Write("用户证件类型(1、身份证；2、军官证；3、护照)：");
            ...
            if (cardType == "1" || cardType == "2" || cardType == "3")
            {
                ...
                Console.Write("用户邮箱地址：");
                user.Mail = Console.ReadLine();
                Console.Write("用户手机号(无纸化彩票中大奖的凭证之一)：");
                user.Mobile = Console.ReadLine();
                Console.Write("用户真实姓名：");
            ...
            Console.Write("上面的投注是否成功？(1、成功；2、失败)：");
            ...
            Console.Write("请输入号充值Id(请COPY上面\"充值请求信息\"中的id)：");
            ...
            try
            {
                ...
                Console.Write("开户行所在省或直辖市名称：");
                drawing.Province = Console.ReadLine();
                Console.Write("开户行所在城市：");
                drawing.City = Console.ReadLine();
                Console.Write("分行或支行、分理处名称：");
