<%@ page language="C#" autoeventwireup="true" CodeFile="~/Lottery/Buy_CQSSC.aspx.cs" inherits="Lottery_Buy_CQSSC" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../Home/Room/Buy_SSC.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../Home/Room/JavaScript/buy_CQSSC.js" type="text/javascript"></script>
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 80%; margin-top: 6px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/WinQuery/28-0-0.aspx") %>" target="_blank">时时彩中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                            ...
                            <tr>
                                ...
                                <td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px; padding-top: 5px;'>
                                    <table width='100%' cellpadding='0' border='0' cellspacing='0' style='text-align: center;
                                        margin-top: 5px;' id='tbPlayTypeMenu28'>
                                        <tr>
