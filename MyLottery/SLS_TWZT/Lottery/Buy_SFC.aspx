<%@ page language="C#" autoeventwireup="true" CodeFile="~/Lottery/Buy_SFC.aspx.cs" inherits="Lottery_Buy_SFC" enableEventValidation="false" %>
                ...
                <div id="divNewBuy">
                    <table width="612" cellspacing="1" cellpadding="0" bgcolor="#C0DBF9" style="margin-top: 10px;">
                        <tbody>
                            ...
                            <input type='radio' name='playType' id='playType101' value='101' checked='checked' onclick='clickPlayType(this.value)' />单式
                            <input type='radio' name='playType' id='playType102' value='102' onclick='clickPlayType(this.value)' />复式
                            <input type='radio' name='playType' id='playType1011' value='1011' checked='checked' onclick='clickPlayType(this.value)' />单式预投
