...
public partial class Agent_ElectronTicket_AgentRewardBet : ElectronTicketAgentsPageBase, IRequiresSessionState
{
    ...
    private void BindData()
    {
        ...
        {
            condition = condition + " and LotteryID= " + Utility.FilteSqlInfusion(this.ddlLottery.SelectedItem.Value);
        }
        ...
        DataTable dt = new Views.V_ElectronTicketAgentSchemes().Open("ID, DateTime, SchemeNumber, Amount, LotteryName, PlayTypeName, WinMoney, Identifiers", condition, "DateTime");
        if (dt != null)
        {
