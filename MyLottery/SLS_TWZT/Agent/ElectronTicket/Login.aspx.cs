...
public partial class Agent_ElectronTicket_Login : SitePageBase, IRequiresSessionState
{
    ...
    public int LoginSubmit(Page page, Sites site, string ID, string Password, string InputCheckCode, ShoveCheckCode sccCheckCode, ref string ReturnDescription)
    {
        ...
        Thread.Sleep(500);
        return new ElectronTicketAgents { ID = _Convert.StrToInt(ID, 0), Password = Password }.Login(ref ReturnDescription);
    }
