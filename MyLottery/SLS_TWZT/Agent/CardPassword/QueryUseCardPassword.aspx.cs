...
public partial class Agent_CardPassword_QueryUseCardPassword : CardPasswordPageBase, IRequiresSessionState
{
    ...
    {
        Shove._Web.Cache.ClearCache("CardPassword_QueryUseCardPassword_" + base._CardPasswordAgentUser.ID.ToString());
        this.BindData();
    }
    ...
    protected void g_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        ...
        {
            e.Item.Cells[0].Text = new CardPassword().GenNumber(PF.GetCallCert(), _Convert.StrToInt(base._CardPasswordAgentUser.ID.ToString(), 0), _Convert.StrToLong(e.Item.Cells[5].Text, 0L));
