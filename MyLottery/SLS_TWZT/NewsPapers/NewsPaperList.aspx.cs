...
public partial class NewsPapers_NewsPaperList : SitePageBase, IRequiresSessionState
{
    ...
    {
        base.Response.Redirect(this.ddlIsusesID.SelectedValue + ".aspx");
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!base.IsPostBack)
        {
            int isuseId = _Convert.StrToInt(Utility.GetRequest("IsuseId"), 0);
            this.BindddlIsuses(isuseId);
            this.BindNewsPaper();
        }
    }
}
