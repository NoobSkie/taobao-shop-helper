<%@ page language="C#" autoeventwireup="true" CodeFile="help_Commission.aspx.cs" inherits="Help_help_Commission" enableEventValidation="false" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <img src="images/help_19_1.gif" /><br />
                        </p>
                        <p>
                            第四步：设置佣金比例<br />
                        </p>
                        <p>
                            <img src="images/help_19_2.gif" /><br />
                        </p>
                        <p>
                            第五步：确认投注<br />
                        </p>
