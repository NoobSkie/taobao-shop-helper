<%@ page language="C#" autoeventwireup="true" CodeFile="help_Scheme.aspx.cs" inherits="Help_help_Scheme" enableEventValidation="false" %>
                ...
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            第三步：保密设置</p>
                        <p>
                            <img src="images/help_12_3.gif" /><br />
                        </p>
                        <p>
                            第四步：确定投注</p>
                        <p>
