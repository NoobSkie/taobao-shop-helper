<%@ page language="C#" autoeventwireup="true" CodeFile="help_UserReg.aspx.cs" inherits="Help_help_UserReg" enableEventValidation="false" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            第一步：登录<%= _Site.Name %>首页、点击注册<br />
                        </p>
                        <p>
                            <img src="images/help_1_1.jpg" class="img"/></p>
                        <p>
                            第二步：填写注册信息<br />
                        </p>
                        <p>
                            <img src="images/help_1_2.jpg" class="img"/><br />
                        </p>
                        <p>
                            第三步：验证手机和激活邮箱</p>
                        <p>
                            <img src="images/help_1_3.jpg" class="img"/><br />
                        </p>
                        <p>
                            <img src="images/help_1_4.jpg" class="img"/><br />
                        </p>
                    </td>
                </tr>
            </table>
