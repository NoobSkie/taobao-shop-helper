<%@ page language="C#" autoeventwireup="true" CodeFile="play_61.aspx.cs" inherits="Help_play_61" enableEventValidation="false" %>
                ...
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="black12" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            ...
                            时时彩每日发行84期，9：00~23:00每10分钟开奖一次。<%=_Site.Name %>将在当期官方开奖前3分钟截止投注，官方开奖后3分钟开奖派奖。
                            <br />
