<%@ page language="C#" autoeventwireup="true" CodeFile="help_Draw_Money.aspx.cs" inherits="Help_help_Draw_Money" enableEventValidation="false" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <img src="images/help_23_5.jpg" />
                        </p>
                        <p>
                            第三步：输入相关密码<br />
                        </p>
                        <p>
                            <img src="images/help_22_2.jpg" /><br />
                        </p>
                        <p>
                            <img src="images/help_23_4.jpg" />
                            <br />
                        </p>
                        <p>
                            第四步：点击下一步<br />
