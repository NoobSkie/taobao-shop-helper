<%@ page language="C#" autoeventwireup="true" CodeFile="help_Cobuy1.aspx.cs" inherits="Help_help_Cobuy1" enableEventValidation="false" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr >
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <img src="images/help_25.gif" class="img"/></p>
                        <p>
                            第二步：点击参与合买<br />
                        </p>
                        <p>
                            <img src="images/help_11_2.gif" class="img"/><br />
                        </p>
                        <p>
                            第三步：点击入伙</p>
                        <p>
                            <img src="images/help_11_3.jpg" class="img"/><br />
                        </p>
                    </td>
                </tr>
            </table>
