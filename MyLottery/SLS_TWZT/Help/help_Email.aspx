<%@ page language="C#" autoeventwireup="true" CodeFile="help_Email.aspx.cs" inherits="Help_help_Email" enableEventValidation="false" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <img src="images/help_20_2.jpg" />
                        </p>
                        <p>
                            第三步：激活邮箱<br />
                        </p>
                        <p>
                            <img src="images/help_20_3.gif" /><br />
                        </p>
                        <p>
                            <img src="images/help_20_4.gif" /><br />
                        </p>
                        <p>
                            第四步：登录邮箱<br />
                        </p>
