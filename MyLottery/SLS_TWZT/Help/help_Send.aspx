<%@ page language="C#" autoeventwireup="true" CodeFile="help_Send.aspx.cs" inherits="Help_help_Send" enableEventValidation="false" %>
    ...
    <div id="content">
        ...
        <div id="help_right">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top: 20px;">
                <tr>
                    <td height="36" align="center" class="red14_2">
                        充值流程
                    </td>
                </tr>
                <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <img src="images/help_3_1.jpg" class="img"/></p>
                        <p>
                            第二步：输入充值金额，选择充值方式，点击下一步<br />
                        </p>
                        <p>
                            <img src="images/help_3_2.jpg" class="img"/><br />
                        </p>
                        <p>
                            第三步：确认充值</p>
                        <p>
                            <img src="images/help_3_3.gif" class="img"/><br />
                        </p>
                    </td>
                </tr>
            </table>
