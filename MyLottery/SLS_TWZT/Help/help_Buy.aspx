<%@ page language="C#" autoeventwireup="true" CodeFile="help_Buy.aspx.cs" inherits="Help_help_Buy" enableEventValidation="false" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <img src="images/help_4_1.gif" class="img"/></p>
                        <p>
                            第二步：选择投注号码，确认号码<br />
                        </p>
                        <p>
                            <img src="images/help_4_2.gif" class="img"/><br />
                        </p>
                        <p>
                            第三步：点击立即投注--购彩成功</p>
                        <p>
                            <img src="images/help_4_3.gif" class="img"/><br />
                        </p>
                    </td>
                </tr>
            </table>
