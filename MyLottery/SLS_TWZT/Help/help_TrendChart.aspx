<%@ page language="C#" autoeventwireup="true" CodeFile="help_TrendChart.aspx.cs" inherits="Help_help_TrendChart" enableEventValidation="false" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <img src="images/help_14_2.gif" /><br />
                        </p>
                        <p>
                            第三步：选择彩种</p>
                        <p>
                            <img src="images/help_14_3.gif" /><br />
                        </p>
                    </td>
                </tr>
            </table>
