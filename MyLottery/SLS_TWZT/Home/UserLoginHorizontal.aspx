<%@ page language="C#" autoeventwireup="true" CodeFile="~/Home/UserLoginHorizontal.aspx.cs" inherits="Home_UserLoginHorizontal" enableEventValidation="false" %>
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" style="background-image: url(Image/Login_bg.jpg); height: 30px;" class="black12">
                            <tr>
                                ...
                                <td style=" padding-left: 5px;" align="center" class="black12" valign="middle">
                                    <a href="Web/UserReg.aspx" target="_parent">免费注册</a> | <a href="Web/ForgetPassword.aspx" target="_parent">忘记密码</a>
                                </td>
