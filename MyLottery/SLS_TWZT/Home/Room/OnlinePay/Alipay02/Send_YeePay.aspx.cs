...
public partial class Home_Room_OnlinePay_Alipay02_Send_YeePay : RoomPageBase, IRequiresSessionState
{
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            this.BankName = "yeepay";
            this.hlOK.NavigateUrl = "../YeePay/Send.aspx?PayMoney=" + this.PayMoney.Text;
