<%@ page language="C#" autoeventwireup="true" CodeFile="~/Home/Room/OnlinePay/Alipay02/Send_Alipay.aspx.cs" inherits="Home_Room_OnlinePay_Alipay02_Send_Alipay" enableEventValidation="false" %>
                                        ...
                                        <td>
                                            <table width="150" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="26">
                                                        <label>
                                                            <asp:RadioButton ID="radHZCBB2C" GroupName="payWay" runat="server" Enabled="False" />
                                                        </label>
                                                    </td>
                                                    <td width="124" height="28">
