...
public partial class Home_Room_JX11X5_WinNotice : Page, IRequiresSessionState
{
    public int width;
    ...
    private void GetWinNotice()
    {
        ...
        {
            builder.Append("&nbsp;&nbsp;&nbsp;<a target=\"_blank\" href=\"Scheme.aspx?id=").Append(row["ID"].ToString()).Append("\">").Append("<span class=\"hui12\">恭喜&nbsp;<span class =\"red12_2\">").Append(_String.Cut(row["InitiateName"].ToString(), 4)).Append("</span>&nbsp;喜中").Append("&nbsp;" + row["PlayTypeName"].ToString()).Append("&nbsp奖金&nbsp</span><span class =\"red12_2\">").Append(_Convert.StrToDouble(row["WinMoney"].ToString(), 0.0).ToString("N")).Append("&nbsp</span><span class=\"hui12\">元</span></a>");
        }
        if (builder.ToString() == "")
        {
