<%@ page language="C#" autoeventwireup="true" CodeFile="~/Home/Room/ZQDC/Buy_SPF.aspx.cs" inherits="Home_Room_ZCDC_Buy_SPF" enableEventValidation="false" %>
    ...
    <div id="cont_box">
        ...
        <div id="Div1" style="margin-top: 10px;">
            <table width="1002" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="100" height="28" align="center" bgcolor="#508AC5" class="bai14">
            ...
            <table width="1002" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="730" background="images/bg_blue_36.jpg" class="black12">
                        ...
                        <input type="checkbox" name="rangqiu" value="0" id="chk1" checked="checked" />
                        <label for="chk1">
                            让球(<span id="rq_changci_span">0</span>场)</label>
                        <input type="checkbox" name="rangqiu" value="1" id="chk2" checked="checked" />
                        <label for="chk2">
                            非让球(<span id="frq_changci_span">0</span>场)</label>
            ...
            <table width="1002" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF"
                ...
                <tr>
                    ...
                    <td width="36" rowspan="2" align="center" bgcolor="#8FB5DA" class="bai12">
                        让球
                    </td>
                    ...
                    <td colspan="4" align="center" bgcolor="#8FB5DA" class="bai12">
                        请选择投注/参考SP值
                    </td>
                </tr>
                <tr>
                    <td width="49" height="25" align="center" bgcolor="#8FB5DA" class="bai12">
                        主胜
                    </td>
                    <td width="48" align="center" bgcolor="#8FB5DA" class="bai12">
                        平局
                    </td>
                    <td width="48" align="center" bgcolor="#8FB5DA" class="bai12">
                        主负
                    </td>
                    <td width="77" align="center" bgcolor="#8FB5DA" class="bai12">
                        主队胜(3)
                    </td>
                    <td width="76" align="center" bgcolor="#8FB5DA" class="bai12">
                        主队平(1)
                    </td>
                    <td width="70" align="center" bgcolor="#8FB5DA" class="bai12">
                        主队负(0)
                    </td>
                ...
                <table width="542" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF"
                    ...
                    <tr>
                        <td height="30" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;" colspan="5">
                            <label for="multiple">
                                倍数：</label><input name="multiple" id="multiple" type="text" maxlength="2" value="1" size="3" />(倍数必须为 0~99 范围的整数)
                        </td>
                    </tr>
                    <tr>
                        <td height="25" class="blue12" style="padding-left: 10px;" colspan="5">
        ...
        <input type="hidden" id="playid" name="playid" value="4501" />
        <input type='hidden' id="minmoney" name='minmoney' value='2' />
        <input type='hidden' id="maxmoney" name='maxmoney' value='20000' />
        
        <!-- A区 结束 -->        
        <!-- B区 开始 -->
        <input type='hidden' id="rq_changci" runat="server" />
        <input type='hidden' id="frq_changci" runat="server" />
        <input type='hidden' id="jzrq_changci" runat="server" />
        <input type='hidden' id="jzfrq_changci" runat="server" />
