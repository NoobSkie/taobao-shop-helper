<%@ page language="C#" autoeventwireup="true" CodeFile="~/Home/Room/ZQDC/Buy_SXDS.aspx.cs" inherits="Home_Room_ZCDC_Buy_SXDS" enableEventValidation="false" %>
...
<body>
    ...
    <div id="cont_box">
        ...
        <div id="Div1" style="margin-top: 10px;">
            ...
            <table width="1002" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF"
                ...
                <tr>
                    ...
                    <td colspan="5" align="center" bgcolor="#8FB5DA" class="bai12">
                        请选择投注/参考SP值
                    </td>
                </tr>
                <tr>
                ...
                <table width="542" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF"
                    ...
                    <tr>
                        <td height="30" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;" colspan="5">
                            <label for="multiple">
                                倍数：</label><input name="multiple" id="multiple" type="text" maxlength="2" value="1" size="3" />(倍数必须为 0~99 范围的的整数)
                        </td>
                    </tr>
                    <tr>
                        <td height="25" class="blue12" style="padding-left: 10px;" colspan="5">
        ...
        <input type="hidden" id="playid" name="playid" value="4503" />
