<%@ page language="C#" autoeventwireup="true" CodeFile="~/Home/Room/ZQDC/Buy_BQC.aspx.cs" inherits="Home_Room_ZCDC_Buy_BQC" enableEventValidation="false" %>
...
<body>
    ...
    <div id="cont_box">
        ...
        <div id="Div1" style="margin-top: 10px;">
            ...
            <table width="1002" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF"
                ...
                <tr>
                    ...
                    <td colspan="10" align="center" bgcolor="#8FB5DA" class="bai12">
                        请选择投注/参考SP值
                    </td>
                </tr>
                <tr>
        ...
        <input type="hidden" id="playid" name="playid" value="4505" />
