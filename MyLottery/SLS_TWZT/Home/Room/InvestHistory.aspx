<%@ page language="C#" autoeventwireup="true" CodeFile="~/Home/Room/InvestHistory.aspx.cs" inherits="Home_Room_InvestHistory" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    <title>我的历史投注纪录-我的购彩纪录-用户中心-<%=_Site.Name %>－手机买彩票，就上<%=_Site.Name %> ！</title>
    ...
    <table id="myIcaileTab" runat="server" width="776" border="0" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td valign="top" id="tdInvest" runat="server" style="background-color: White;">
                <table width="842" border="0" cellpadding="0" cellspacing="0" bgcolor="#DDDDDD">
                    <tr>
                ...
                <asp:DataGrid ID="gHistory" runat="server" Width="842" BorderStyle="None" AllowPaging="false"
