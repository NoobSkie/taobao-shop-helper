...
public partial class Home_Room_SSC_WinNotice : Page, IRequiresSessionState
{
    ...
    private void GetWinNotice()
    {
        ...
        if (cacheAsDataTable == null)
        {
            ...
            {
                this.divWinNotice.InnerHtml = "<tr><td class=\"hui12\">暂无开奖信息</td></tr>";
