<%@ page language="C#" autoeventwireup="true" CodeFile="~/Home/Room/BindAlipay.aspx.cs" inherits="Home_Room_BindAlipay" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    <title>绑定支付宝-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %></title>
            ...
            <td width="100%" height="30" align="center" bgcolor="#FFFFFF" class="black12" style="padding: 10px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <%--<tr bgcolor="#C0DBF9">
                        ...
                        <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">
                            <asp:TextBox ID="tbAlipayAccountNew" runat="server" CssClass="in_text_hui" Width="200px"></asp:TextBox>
                        </td>
                    </tr>--%>
                    <tr bgcolor="#C0DBF9">
