<%@ control language="C#" autoeventwireup="true" CodeFile="Lotteries.ascx.cs" inherits="Home_Room_UserControls_Lotteries" %>
...
<table width="1002" border="0" cellspacing="0" cellpadding="0" align="center">
                        ...
                        <table width="95%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="right"  class="hui12_3" style="width:200px;">
                                    <div id="tdDateTimeNow" style="width:190px;"></div>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                    ...
                                    <table width="192" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="45" rowspan="2">
                                                <a id="aHref29a" href="Javascript:;" runat="server" disabled="true"><img src="<%=ResolveUrl("~/Home/Room/images/cz_gp_logo.gif") %>" width="32" height="36" border="0" alt="高频：时时乐，时时彩，十一运……" /></a>
                                            </td>
                                        ...
                                        <tr>
                                            <td width="60" height="21" class="blue12" style="position: relative;">
                                                <a id="aHref61" href="Javascript:;" runat="server" disabled="true">时时彩</a>
                                                <sup><div class="hot_SSQ"><img src="<%=ResolveUrl("~/Home/Room/images/1672_hot-dserewr23.gif") %>" /></div></sup>
                                            </td>
                                            <td class="blue12">
                                ...
                                <td width="220" style="padding-left: 10px;">
                                    <table width="220" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="45" rowspan="2">
                                                 <a id="aHref5a" href="Javascript:;" runat="server" disabled="true"><img src="<%=ResolveUrl("~/Home/Room/images/cz_fc_logo.gif") %>" width="32" height="32" alt="福彩：双色球，福彩3D，15选5……" /></a>
                                            </td>
                                            <td width="60" height="21" class="blue12" style="position: relative;">
                                ...
                                <td width="340" style="padding-left: 10px;">
                                    <table width="320" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="45" rowspan="2">
                                                <a id="aHref39a" href="Javascript:;" runat="server" disabled="true"><img src="<%=ResolveUrl("~/Home/Room/images/cz_tc_logo.gif") %>" width="35" height="33" alt="体彩：超级大乐透，七星彩，22选5……" /></a>
                                            </td>
                                ...
                                <td style="padding-left: 10px;" align="right">
                                    <table width="178" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="45" rowspan="2">
                                                <a id="aHref1a" href="Javascript:;" runat="server" disabled="true"><img src="<%=ResolveUrl("~/Home/Room/images/cz_zc_logo.gif") %>" width="34" height="34" alt="体彩：胜负彩，六场半全场，四场进球彩……" /></a>
                                            </td>
    ...
    <tr id="trNoticeValid" runat="server" visible="false">
        <td align="center" style="border-left:1px solid #BCD2E9;border-right:1px solid #BCD2E9;border-bottom:1px solid #BCD2E9;" class="blue12">
            <span class="red12_2">亲爱的<asp:Label ID="lblUserNameLottery" runat="server"></asp:Label>，您好！请您尽快完成<a href="<%=ResolveUrl("~/Home/Room/UserMobileBind.aspx") %>">手机安全验证</a>或<a href="<%=ResolveUrl("~/Home/Room/UserEmailBind.aspx") %>">邮箱激活</a>的操作。未通过验证的会员于2009年12月18日后将无法正常投注！</span><a href="<%=ResolveUrl("~/Home/Room/UserMobileBind.aspx") %>">【手机验证】</a>&nbsp;&nbsp;<a href="<%=ResolveUrl("~/Home/Room/UserEmailBind.aspx") %>">【邮箱激活】</a>
        </td>
    </tr>
    <tr id="trNotice">
