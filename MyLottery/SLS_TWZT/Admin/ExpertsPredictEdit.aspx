<%@ page language="C#" autoeventwireup="true" CodeFile="ExpertsPredictEdit.aspx.cs" inherits="Admin_ExpertsPredictEdit" enableEventValidation="false" %>
    ...
    <table cellspacing="0" cellpadding="0" width="90%" align="center" border="0">
            ...
            <tr>
                <td>
                        ...
                        <%--<input id="tbImage" style="width: 600px; height: 21px" type="file" size="80" name="tbImage" runat="server"/>--%><asp:CheckBox ID="cbNoEditImage" runat="server" Text="不修改图片" Checked="True"></asp:CheckBox>
