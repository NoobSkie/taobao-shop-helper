<%@ page language="C#" autoeventwireup="true" CodeFile="InputOpenAffiche.aspx.cs" inherits="Admin_InputOpenAffiche" validaterequest="false" enableEventValidation="false" %>
        ...
        <div>
            ...
            <table id="Table1" cellspacing="0" cellpadding="0" width="90%" align="center" border="0">
                ...
                <tr>
                    <td style="height: 21px">
                        上传开奖视频文件
                        <input id="fileVideo" runat="server" name="fileVideo" style="width: 500px; height: 21px" type="file" /></td>
                </tr>
                <tr>
                    <td align="center" style="height: 50px">
                        <ShoveWebUI:ShoveConfirmButton ID="btnOK" runat="server" BackgroupImage="../Images/Admin/buttbg.gif" Width="60px" Height="20px" Text="保存" AlertText="确信输入无误，并立即保存吗？" OnClick="btnOK_Click" />
                    </td>
                </tr>
            </table>
            <br />
