<%@ page language="C#" autoeventwireup="true" CodeFile="PrintOutNotFull.aspx.cs" inherits="Admin_PrintOutNotFull" enableEventValidation="false" %>
                ...
                <tr>
                    <td style="height: 21px">
                        <font face="宋体">选择电子票接口
                            <asp:DropDownList ID="ddlElectronTicket" runat="server" AutoPostBack="True" Width="160px" OnSelectedIndexChanged="ddlElectronTicket_SelectedIndexChanged">
                            </asp:DropDownList>
                            选择彩票类型
                            ...
                            <ShoveWebUI:ShoveConfirmButton ID="btnRefresh" BackgroupImage="../Images/Admin/buttbg.gif" runat="server" Width="60px" Height="20px" Text="刷新" OnClick="btnRefresh_Click" />
                        </font>
                    </td>
                </tr>
                <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                        <td width="6%">
                                            ...
                                            <input id="tbSchemeID" style="width: 37px; height: 21px" type="hidden" size="1" value='<%# DataBinder.Eval(Container.DataItem,"ID")%>' name="tbSchemeID" runat="server" /></td>
                                        <td width="16%">
                                        ...
                                        <td width="6%">
                                            ...
                                            %</td>
                                        <td width="7%">
                                            <ShoveWebUI:ShoveConfirmButton ID="btnQuash" BackgroupImage="../Images/Admin/buttbg.gif" runat="server" Width="60px" Height="20px" Text="撤单" AlertText="确信要撤消此单吗？" CommandName="btnQuash" /></td>
                                        <td width="7%">
                                            <ShoveWebUI:ShoveConfirmButton ID="btnPrintOut" BackgroupImage="../Images/Admin/buttbg.gif" runat="server" Width="60px" Height="20px" Text="出票" AlertText="确信要作为已出票吗？" CommandName="btnPrintOut" /></td>
                                    </tr>
                                </table>
                            </ItemTemplate>
                        </asp:DataList>
