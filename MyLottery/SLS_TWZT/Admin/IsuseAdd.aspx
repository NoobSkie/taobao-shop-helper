<%@ page language="C#" autoeventwireup="true" CodeFile="IsuseAdd.aspx.cs" inherits="Admin_IsuseAdd" enableEventValidation="false" %>
                            ...
                            <table id="tableCompetitionNum" runat="server" align="center" visible="true" style="width: 642px">
                                <tr>
                                    <td align="left" style="width: 638px">
                                        &nbsp;&nbsp;&nbsp;本期比赛总场数：<asp:TextBox ID="CompetitionNum" runat="server" onkeypress="return CompetitionNumOnPress();"></asp:TextBox><ShoveWebUI:ShoveConfirmButton ID="btCompetitionNum" BackgroupImage="../Images/Admin/buttbg.gif" runat="server" Width="60px" Height="20px" AlertText="确定后将无法增加，确认书写无误吗？" Text="确定" OnClick="btCompetitionNum_Click" />
