...
public partial class Admin_InputWinNumber2 : AdminPageBase, IRequiresSessionState
{
    ...
    protected void btnGO_Click(object sender, EventArgs e)
    {
        ...
        else if (new Tables.T_Isuses { WinLotteryNumber = { Value = this.tbWinNumber.Text }, IsOpened = { Value = 1 } }.Update("[ID] = " + Utility.FilteSqlInfusion(this.ddlIsuse.SelectedValue)) < 0L)
        {
            PF.GoError(4, "数据库繁忙，请重试", base.GetType().FullName);
        }
        else
