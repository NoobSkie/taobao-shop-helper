...
public partial class Admin_Isuse2 : AdminPageBase, IRequiresSessionState
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        if (this.ddlLottery.Items.Count >= 1)
        {
            base.Response.Redirect("IsuseAdd2.aspx?LotteryID=" + this.ddlLottery.SelectedValue, true);
        }
    }
