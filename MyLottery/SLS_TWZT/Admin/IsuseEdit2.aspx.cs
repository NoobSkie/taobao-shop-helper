...
public partial class Admin_IsuseEdit2 : AdminPageBase, IRequiresSessionState
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!base.IsPostBack)
        {
            ...
            {
                int num2 = _Convert.StrToInt(Utility.GetRequest("LotteryID"), -1);
                if (((((num2 != 1) && (num2 != 2)) && ((num2 != 3) && (num2 != 4))) && (((num2 != 9) && (num2 != 10)) && ((num2 != 14) && (num2 != 15)))) && (num2 != 0x27))
                {
                    PF.GoError(1, "参数错误", base.GetType().FullName);
                }
                else
                {
                    ...
                    this.tbLotteryID.Text = num2.ToString();
                    switch (num2)
                    {
                        case 1:
