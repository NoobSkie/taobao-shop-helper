...
public partial class Admin_UserDistillProcessing : AdminPageBase, IRequiresSessionState
{
    ...
    protected void g_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Pay")
        {
            ...
            if (Procedures.P_DistillPaySuccess(base._Site.ID, userID, distillID, "已付款", base._User.ID, ref returnValue, ref returnDescription) < 0)
            {
