<%@ page language="C#" autoeventwireup="true" CodeFile="FocusNews.aspx.cs" inherits="Admin_FocusNews" enableEventValidation="false" %>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="编辑">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <ShoveWebUI:ShoveLinkButton ID="btnDel" runat="server" CommandName="Del" AlertText="您确信要删除此条新闻吗？">删除</ShoveWebUI:ShoveLinkButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
