<%@ page language="C#" autoeventwireup="true" CodeFile="AdvertisementsEdit.aspx.cs" inherits="Admin_AdvertisementsEdit" enableEventValidation="false" %>
    ...
    <div>
        ...
        <table cellspacing="0" cellpadding="0" width="90%" align="center" border="0">
            ...
            <tr>
                <td>
                    <font face="宋体">标题
                        <asp:TextBox ID="tbName" runat="server" Width="400px" MaxLength="50"></asp:TextBox></font>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td style="height: 50px" align="center">
                    <ShoveWebUI:ShoveConfirmButton ID="btnEdit" runat="server" Width="60px" Height="20px"
                        BackgroupImage="../Images/Admin/buttbg.gif" Text="保存" OnClick="btnEdit_Click" />
                </td>
            </tr>
        </table>
        <br />
