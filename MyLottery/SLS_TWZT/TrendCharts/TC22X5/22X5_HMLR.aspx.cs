...
public partial class TC22X5_22X5_HMLR : Page, IRequiresSessionState
{
    private int[] a = new int[0x16];
    private int[] b = new int[0x16];
    ...
    private void DrawGridRow(HtmlTextWriter output, Control ctl)
    {
        ...
        int[] numArray = new int[0x16];
        for (int i = 0; i < 0x16; i++)
        {
            numArray[i] = (this.a[i] * 150) / num;
        }
        ...
        for (int k = 0; k < 0x16; k++)
        {
            output.Write("<td align='center' valign='bottom' background='../Image/line[1].gif' width='28px'>");
            output.Write("<Img src='../Image/01[1].gif ' height='" + numArray[k].ToString() + "' width='8' title='" + this.a[k].ToString() + "'></td>");
        }
        output.Write("<tr align='center' valign='middle'>");
    ...
    protected void GridView2Bind()
    {
        ...
        table = BLL.TC22X5_lengrejj_SeleteByNum(30);
    ...
    {
        DataTable table = new DataTable();
        table = BLL.TC22X5_lengre_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.TC22X5_lengre_SeleteByNum(100);
        DataTable table2 = BLL.TC22X5_lengrejj_SeleteByNum(100);
    ...
    {
        DataTable table = BLL.TC22X5_lengre_SeleteByNum(50);
        DataTable table2 = new DataTable();
        table2 = BLL.TC22X5_lengrejj_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        DataTable table3 = new DataTable();
    ...
    {
        DataTable table = BLL.TC22X5_lengre_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        DataTable table2 = new DataTable();
        table2 = BLL.TC22X5_lengrejj_SeleteByNum(30);
        DataTable table3 = new DataTable();
        table3.Columns.Add("num", typeof(string));
        DataRow row = table3.NewRow();
        row[0] = "12";
    ...
    {
        DataTable table = BLL.TC22X5_lengre_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        DataTable table2 = new DataTable();
        table2 = BLL.TC22X5_lengrejj_SeleteByNum(20);
        DataTable table3 = new DataTable();
        table3.Columns.Add("num", typeof(string));
        DataRow row = table3.NewRow();
        row[0] = "12";
    ...
    {
        DataTable table = BLL.TC22X5_lengre_SeleteByNum(10);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        DataTable table2 = new DataTable();
        table2 = BLL.TC22X5_lengrejj_SeleteByNum(10);
        DataTable table3 = new DataTable();
        table3.Columns.Add("num", typeof(string));
        DataRow row = table3.NewRow();
        row[0] = "12";
