...
public partial class TC22X5_22X5_WeiHao : Page, IRequiresSessionState
{
    ...
    private void DrawGridFooter(HtmlTextWriter output, Control ctl)
    {
        ...
        for (int i = 0; i < 0x16; i++)
        {
            ...
            output.Write(this.num[i].ToString() + "<br><img src='../image/01[1].gif' height='" + this.sum[i].ToString() + "px' title = '" + this.num[i].ToString() + "' width= '8px'></td>");
        }
    ...
    {
        this.GridView1.DataSource = BLL.TC22X5_Weihao_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.TC22X5_Weihao_SeleteByNum(100);
    ...
    {
        DataTable table = BLL.TC22X5_Weihao_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
    ...
    {
        DataTable table = BLL.TC22X5_Weihao_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
    ...
    {
        DataTable table = BLL.TC22X5_Weihao_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
    ...
    {
        DataTable table = BLL.TC22X5_Weihao_SeleteByNum(10);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
