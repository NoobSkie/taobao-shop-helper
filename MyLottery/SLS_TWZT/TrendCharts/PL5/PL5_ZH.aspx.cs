...
public partial class PL5_PL5_ZH : TrendChartPageBase, IRequiresSessionState
{
    ...
    protected void ColorBind()
    {
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            ...
            {
                if ((this.GridView1.Rows[i].Cells[j].Text == "质") || (this.GridView1.Rows[i].Cells[j].Text == "合"))
                {
    ...
    protected void GridViewBind()
    {
        ...
        table = BLL.PL5_ZH_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.PL5_ZH_SeleteByNum(100);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.PL5_ZH_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.PL5_ZH_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.PL5_ZH_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.PL5_ZH_SeleteByNum(10);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
