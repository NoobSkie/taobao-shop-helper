...
public partial class PL5_PL5_CF : TrendChartPageBase, IRequiresSessionState
{
    ...
    {
        this.GridView1.DataSource = BLL.PL5_CF_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.PL5_CF_SeleteByNum(100);
    ...
    {
        DataTable table = BLL.PL5_CF_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
    ...
    {
        DataTable table = BLL.PL5_CF_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
    ...
    {
        DataTable table = BLL.PL5_CF_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
    ...
    {
        DataTable table = BLL.PL5_CF_SeleteByNum(10);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
