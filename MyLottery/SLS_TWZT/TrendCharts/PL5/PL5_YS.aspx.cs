...
public partial class PL5_PL5_YS : TrendChartPageBase, IRequiresSessionState
{
    ...
    {
        this.GridView1.DataSource = BLL.PL5_YS_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.PL5_YS_SeleteByNum(100);
    ...
    {
        DataTable table = BLL.PL5_YS_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.PL5_YS_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.PL5_YS_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.PL5_YS_SeleteByNum(10);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
