...
public partial class _7Xing_7X_YS : TrendChartPageBase, IRequiresSessionState
{
    ...
    private void ColorBind()
    {
        ...
        for (int m = 1; m < this.GridView1.Columns.Count; m++)
        {
            for (int num8 = 0; num8 < this.GridView1.Rows.Count; num8++)
            {
                this.GridView1.Rows[num8].Cells[1].ForeColor = Color.Blue;
                if (this.GridView1.Rows[num8].Cells[m].Text == "")
                {
                    this.GridView1.Rows[num8].Cells[m].Text = "&nbsp;";
                }
    ...
    {
        this.GridView1.DataSource = BLL.X7_YS_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.X7_YS_SeleteByNum(100);
    ...
    {
        DataTable table = BLL.X7_YS_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.X7_YS_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.X7_YS_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.X7_YS_SeleteByNum(10);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
