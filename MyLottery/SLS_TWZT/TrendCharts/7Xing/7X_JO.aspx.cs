...
public partial class _7Xing_7X_JO : TrendChartPageBase, IRequiresSessionState
{
    ...
    protected void ColorBind()
    {
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            ...
            {
                if ((this.GridView1.Rows[i].Cells[j].Text == "奇") || (this.GridView1.Rows[i].Cells[j].Text == "偶"))
                {
    ...
    protected void GridViewBind()
    {
        ...
        table = BLL.X7_JO_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.X7_JO_SeleteByNum(100);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.X7_JO_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.X7_JO_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.X7_JO_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.X7_JO_SeleteByNum(10);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
