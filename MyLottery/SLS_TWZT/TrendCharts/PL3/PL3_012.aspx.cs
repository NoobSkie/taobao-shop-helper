...
public partial class View_PL3_012 : TrendChartPageBase, IRequiresSessionState
{

    protected void databind()
    {
        this.GridView1.DataSource = BLL.PL3_012_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.PL3_012_SeleteByNum(100);
    ...
    {
        DataTable table = BLL.PL3_012_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
    ...
    {
        DataTable table = BLL.PL3_012_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
    ...
    {
        DataTable table = BLL.PL3_012_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
    ...
    {
        DataTable table = BLL.PL3_012_SeleteByNum(10);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.GridViewbindColor();
    }
