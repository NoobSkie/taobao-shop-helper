...
public partial class View_PL3_ZH : TrendChartPageBase, IRequiresSessionState
{
    ...
    protected void ColorBind()
    {
        ...
        for (int j = 0; j < this.GridView1.Rows.Count; j++)
        {
            for (int num3 = 2; num3 < 7; num3++)
            {
                ...
                if ((this.GridView1.Rows[j].Cells[num3].Text == "质") || (this.GridView1.Rows[j].Cells[num3].Text == "合"))
                {
        ...
        for (int k = 0; k < this.GridView1.Rows.Count; k++)
        {
            for (int num5 = 7; num5 < 12; num5++)
            {
                ...
                if ((this.GridView1.Rows[k].Cells[num5].Text == "质") || (this.GridView1.Rows[k].Cells[num5].Text == "合"))
                {
        ...
        for (int m = 0; m < this.GridView1.Rows.Count; m++)
        {
            for (int num7 = 12; num7 < 0x11; num7++)
            {
                ...
                if ((this.GridView1.Rows[m].Cells[num7].Text == "质") || (this.GridView1.Rows[m].Cells[num7].Text == "合"))
                {
    ...
    protected void GridViewBind()
    {
        ...
        table = BLL.PL3_ZH_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.PL3_ZH_SeleteByNum(100);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.PL3_ZH_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.PL3_ZH_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        DataTable table = BLL.PL3_ZH_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        this.ColorBind();
    }
    ...
    {
        BLL.PL3_ZH_SeleteByNum(10);
        this.GridView1.DataSource = BLL.PL3_DX_SeleteByNum(10);
        this.GridView1.DataBind();
        this.ColorBind();
    }
}
