...
public partial class Home_TrendCharts_SHSSL_SHSSL_HZ : TrendChartPageBase, IRequiresSessionState
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            table = new TrendChart().SHSSL_HZ_Select(0, this.tb1.Text.ToString(), this.tb2.Text.ToString(), ref result);
    ...
    protected void btnTop100_Click(object sender, EventArgs e)
    {
        ...
        table = new TrendChart().SHSSL_HZ_Select(100, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop50_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().SHSSL_HZ_Select(50, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
