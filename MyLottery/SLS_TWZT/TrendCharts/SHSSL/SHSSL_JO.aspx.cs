...
public partial class Home_TrendCharts_SHSSL_SHSSL_JO : TrendChartPageBase, IRequiresSessionState
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            table = new TrendChart().SHSSL_JO_Select(0, this.tb1.Text.ToString(), this.tb2.Text.ToString(), ref result);
    ...
    protected void btnTop100_Click(object sender, EventArgs e)
    {
        ...
        table = new TrendChart().SHSSL_JO_Select(100, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop30_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().SHSSL_JO_Select(30, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop50_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().SHSSL_JO_Select(50, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void ColorBind()
    {
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            ...
            {
                this.GridView1.Rows[i].Cells[2].Text = "奇";
            ...
            {
                this.GridView1.Rows[i].Cells[3].Text = "偶";
            ...
            {
                this.GridView1.Rows[i].Cells[4].Text = "奇";
            ...
            {
                this.GridView1.Rows[i].Cells[5].Text = "偶";
            ...
            {
                this.GridView1.Rows[i].Cells[6].Text = "奇";
            ...
            {
                this.GridView1.Rows[i].Cells[7].Text = "偶";
            ...
            {
                this.GridView1.Rows[i].Cells[0x16].Text = "奇";
            ...
            {
                this.GridView1.Rows[i].Cells[0x17].Text = "偶";
