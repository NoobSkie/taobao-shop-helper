...
public partial class Home_TrendCharts_JXSSC_SSC_5X_JOZST : TrendChartPageBase, IRequiresSessionState
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            table = new TrendChart().SSC_5X_JOZST_Select(0, this.tb1.Text.ToString(), this.tb2.Text.ToString(), ref result);
    ...
    protected void btnTop100_Click(object sender, EventArgs e)
    {
        ...
        table = new TrendChart().SSC_5X_JOZST_Select(100, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop30_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().SSC_5X_JOZST_Select(30, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop50_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().SSC_5X_JOZST_Select(50, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void ColorBind()
    {
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            if (this.GridView1.Rows[i].Cells[8].Text == "0")
            {
                ...
                this.GridView1.Rows[i].Cells[8].Controls.Add(child);
            }
            ...
            {
                if ((_Convert.StrToInt(this.GridView1.Rows[i].Cells[num2].Text, 0) == 0) && (_Convert.StrToInt(this.GridView1.Rows[i].Cells[num2].Text, -1) == 0))
                {
            ...
            {
                if ((_Convert.StrToInt(this.GridView1.Rows[i].Cells[num4].Text, 0) == 0) && (_Convert.StrToInt(this.GridView1.Rows[i].Cells[num4].Text, -1) == 0))
                {
            ...
            {
                if ((_Convert.StrToInt(this.GridView1.Rows[i].Cells[num6].Text, 0) == 0) && (_Convert.StrToInt(this.GridView1.Rows[i].Cells[num6].Text, -1) == 0))
                {
            ...
            {
                if ((_Convert.StrToInt(this.GridView1.Rows[i].Cells[num8].Text, 0) == 0) && (_Convert.StrToInt(this.GridView1.Rows[i].Cells[num8].Text, -1) == 0))
                {
