...
public partial class Home_TrendCharts_JXSSC_SSC_3X_JOZST : TrendChartPageBase, IRequiresSessionState
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            table = new TrendChart().SSC_3X_JOZST_Select(0, this.tb1.Text.ToString(), this.tb2.Text.ToString(), ref result);
    ...
    protected void btnTop100_Click(object sender, EventArgs e)
    {
        ...
        table = new TrendChart().SSC_3X_JOZST_Select(100, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop30_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().SSC_3X_JOZST_Select(30, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop50_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().SSC_3X_JOZST_Select(50, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void ColorBind()
    {
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            ...
            {
                this.GridView1.Rows[i].Cells[3].Text = "奇奇奇";
            ...
            {
                this.GridView1.Rows[i].Cells[4].Text = "奇奇偶";
            ...
            {
                this.GridView1.Rows[i].Cells[5].Text = "奇偶奇";
            ...
            {
                this.GridView1.Rows[i].Cells[6].Text = "奇偶偶";
            ...
            {
                this.GridView1.Rows[i].Cells[7].Text = "偶奇奇";
            ...
            {
                this.GridView1.Rows[i].Cells[8].Text = "偶奇偶";
            ...
            {
                this.GridView1.Rows[i].Cells[9].Text = "偶偶奇";
            ...
            {
                this.GridView1.Rows[i].Cells[10].Text = "偶偶偶";
            ...
            {
                this.GridView1.Rows[i].Cells[12].Text = "0奇";
            ...
            {
                this.GridView1.Rows[i].Cells[13].Text = "1奇";
            ...
            {
                this.GridView1.Rows[i].Cells[14].Text = "2奇";
            ...
            {
                this.GridView1.Rows[i].Cells[15].Text = "3奇";
