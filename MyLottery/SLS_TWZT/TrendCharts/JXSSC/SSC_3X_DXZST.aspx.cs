...
public partial class Home_TrendCharts_JXSSC_SSC_3X_DXZST : TrendChartPageBase, IRequiresSessionState
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            table = new TrendChart().SSC_3X_DXZST_Select(0, this.tb1.Text.ToString(), this.tb2.Text.ToString(), ref result);
    ...
    protected void btnTop100_Click(object sender, EventArgs e)
    {
        ...
        table = new TrendChart().SSC_3X_DXZST_Select(100, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop30_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().SSC_3X_DXZST_Select(30, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop50_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().SSC_3X_DXZST_Select(50, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void ColorBind()
    {
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            ...
            {
                this.GridView1.Rows[i].Cells[3].Text = "大大大";
            ...
            {
                this.GridView1.Rows[i].Cells[4].Text = "大大小";
            ...
            {
                this.GridView1.Rows[i].Cells[5].Text = "大小大";
            ...
            {
                this.GridView1.Rows[i].Cells[6].Text = "大小小";
            ...
            {
                this.GridView1.Rows[i].Cells[7].Text = "小大大";
            ...
            {
                this.GridView1.Rows[i].Cells[8].Text = "小大小";
            ...
            {
                this.GridView1.Rows[i].Cells[9].Text = "小小大";
            ...
            {
                this.GridView1.Rows[i].Cells[10].Text = "小小小";
            ...
            {
                this.GridView1.Rows[i].Cells[12].Text = "0大";
            ...
            {
                this.GridView1.Rows[i].Cells[13].Text = "1大";
            ...
            {
                this.GridView1.Rows[i].Cells[14].Text = "2大";
            ...
            {
                this.GridView1.Rows[i].Cells[15].Text = "3大";
