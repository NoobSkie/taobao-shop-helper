...
public partial class Home_TrendCharts_DF6_1_DF61_ZHFB : TrendChartPageBase, IRequiresSessionState
{
    ...
    private void BindDataForAD()
    {
        ...
        DataRow[] rowArray = cacheAsDataTable.Select("LotteryID=58 and [Name] = '广告一'", "[Order]");
        DataRow[] rowArray2 = cacheAsDataTable.Select("LotteryID=58 and [Name] = '广告二'", "[Order]");
        DataRow[] rowArray3 = cacheAsDataTable.Select("LotteryID=58 and [Name] = '广告三'", "[Order]");
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            table = new TrendChart().DF61_ZHFB_Select(0, this.tb1.Text.ToString(), this.tb2.Text.ToString(), ref result);
    ...
    protected void btnTop100_Click(object sender, EventArgs e)
    {
        ...
        table = new TrendChart().DF61_ZHFB_Select(100, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop30_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().DF61_ZHFB_Select(30, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop50_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().DF61_ZHFB_Select(50, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
        ...
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            ...
            for (int j = 1; j < 11; j++)
            {
                if (_Convert.StrToInt(this.GridView1.Rows[i].Cells[j].Text, 0) == 0)
                {
                    ...
                    strArray[6] = "' />";
                    strArray[7] = (j - 1).ToString();
                    child.Text = string.Concat(strArray);
                    if (str != "")
                    {
                        text = this.lbline.Text;
            ...
            for (int k = 11; k < 0x15; k++)
            {
                if ((_Convert.StrToInt(this.GridView1.Rows[i].Cells[k].Text, 0) == 0) && (_Convert.StrToInt(this.GridView1.Rows[i].Cells[k].Text, 0) == 0))
                {
                    ...
                    strArray4[6] = "' />";
                    strArray4[7] = (k - 11).ToString();
                    label2.Text = string.Concat(strArray4);
                    if (str2 != "")
                    {
                        string str9 = this.lbline.Text;
            ...
            for (int m = 0x15; m < 0x1f; m++)
            {
                if ((_Convert.StrToInt(this.GridView1.Rows[i].Cells[m].Text, 0) == 0) && (_Convert.StrToInt(this.GridView1.Rows[i].Cells[m].Text, 0) == 0))
                {
                    ...
                    strArray7[6] = "' />";
                    strArray7[7] = (m - 0x15).ToString();
                    label3.Text = string.Concat(strArray7);
                    if (str3 != "")
                    {
                        string str10 = this.lbline.Text;
            ...
            for (int n = 0x1f; n < 0x29; n++)
            {
                if (_Convert.StrToInt(this.GridView1.Rows[i].Cells[n].Text, 0) == 0)
                {
                    ...
                    strArray10[6] = "' />";
                    strArray10[7] = (n - 0x1f).ToString();
                    label4.Text = string.Concat(strArray10);
                    if (str4 != "")
                    {
                        string str11 = this.lbline.Text;
            ...
            for (int num22 = 0x29; num22 < 0x33; num22++)
            {
                if (((_Convert.StrToInt(this.GridView1.Rows[i].Cells[num22].Text, 0) == 0) && (_Convert.StrToInt(this.GridView1.Rows[i].Cells[num22].Text, 0) == 0)) && (_Convert.StrToInt(this.GridView1.Rows[i].Cells[num22].Text, 0) == 0))
                {
                    Label label5 = new Label();
                    string[] strArray13 = new string[8];
                    strArray13[0] = "<strong style='color:red' id='GridView1_ctl";
                    int num23 = i + 2;
                    strArray13[1] = num23.ToString().PadLeft(2, '0');
                    strArray13[2] = "_";
                    strArray13[3] = i.ToString();
                    strArray13[4] = "_";
                    strArray13[5] = num22.ToString();
                    strArray13[6] = "' />";
                    strArray13[7] = (num22 - 0x29).ToString();
                    label5.Text = string.Concat(strArray13);
                    if (str5 != "")
                    {
                        string str12 = this.lbline.Text;
                        string[] strArray14 = new string[10];
                        strArray14[0] = str12;
                        strArray14[1] = "DrawLine('";
                        strArray14[2] = str5;
                        strArray14[3] = "','GridView1_ctl";
                        int num25 = i + 2;
                        strArray14[4] = num25.ToString().PadLeft(2, '0');
                        strArray14[5] = "_";
                        strArray14[6] = i.ToString();
                        strArray14[7] = "_";
                        strArray14[8] = num22.ToString();
                        strArray14[9] = "', 'blue');";
                        this.lbline.Text = string.Concat(strArray14);
                    }
                    this.GridView1.Rows[i].Cells[num22].Controls.Add(label5);
                    string[] strArray15 = new string[6];
                    strArray15[0] = "GridView1_ctl";
                    num3 = i + 2;
                    strArray15[1] = num3.ToString().PadLeft(2, '0');
                    strArray15[2] = "_";
                    strArray15[3] = i.ToString();
                    strArray15[4] = "_";
                    strArray15[5] = num22.ToString();
                    str5 = string.Concat(strArray15);
                }
            }
            for (int num26 = 0x33; num26 < 0x3d; num26++)
            {
                if ((_Convert.StrToInt(this.GridView1.Rows[i].Cells[num26].Text, 0) == 0) && (_Convert.StrToInt(this.GridView1.Rows[i].Cells[num26].Text, 0) == 0))
                {
                    Label label6 = new Label();
                    strArray = new string[8];
                    strArray[0] = "<strong style='color:blue' id='GridView1_ctl";
                    num3 = i + 2;
                    strArray[1] = num3.ToString().PadLeft(2, '0');
                    strArray[2] = "_";
                    strArray[3] = i.ToString();
                    strArray[4] = "_";
                    strArray[5] = num26.ToString();
                    strArray[6] = "' />";
                    num3 = num26 - 0x33;
                    strArray[7] = num3.ToString();
                    label6.Text = string.Concat(strArray);
                    if (str6 != "")
                    {
                        text = this.lbline.Text;
                        ...
                        strArray[1] = "DrawLine('";
                        strArray[2] = str6;
                        strArray[3] = "','GridView1_ctl";
                        num3 = i + 2;
                        strArray[4] = num3.ToString().PadLeft(2, '0');
                        strArray[5] = "_";
                        strArray[6] = i.ToString();
                        strArray[7] = "_";
                        strArray[8] = num26.ToString();
                        strArray[9] = "', 'red');";
                        this.lbline.Text = string.Concat(strArray);
                    }
                    this.GridView1.Rows[i].Cells[num26].Controls.Add(label6);
                    strArray = new string[6];
                    strArray[0] = "GridView1_ctl";
                    num3 = i + 2;
                    strArray[1] = num3.ToString().PadLeft(2, '0');
                    strArray[2] = "_";
                    strArray[3] = i.ToString();
                    strArray[4] = "_";
                    strArray[5] = num26.ToString();
                    str6 = string.Concat(strArray);
                }
            }
            for (int num27 = 0x3d; num27 < 0x49; num27++)
            {
                if ((_Convert.StrToInt(this.GridView1.Rows[i].Cells[num27].Text, 0) == 0) && (_Convert.StrToInt(this.GridView1.Rows[i].Cells[num27].Text, 0) == 0))
                {
                    ...
                    strArray[3] = i.ToString();
                    strArray[4] = "_";
                    strArray[5] = num27.ToString();
                    strArray[6] = "' />";
                    num3 = num27 - 0x3d;
                    strArray[7] = num3.ToString();
                    label7.Text = string.Concat(strArray);
                    if (str7 != "")
                    {
                        text = this.lbline.Text;
                        strArray = new string[10];
                        ...
                        strArray[6] = i.ToString();
                        strArray[7] = "_";
                        strArray[8] = num27.ToString();
                        strArray[9] = "', 'blue');";
                        this.lbline.Text = string.Concat(strArray);
                    }
                    this.GridView1.Rows[i].Cells[num27].Controls.Add(label7);
                    strArray = new string[6];
                    strArray[0] = "GridView1_ctl";
                    num3 = i + 2;
                    strArray[1] = num3.ToString().PadLeft(2, '0');
    ...
    protected void DrawGridFooter(HtmlTextWriter output, Control ctl)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            for (int num2 = 0; num2 < 10; num2++)
            {
                ...
                output.Write(num2.ToString() + "</strong></span></td>");
            }
        ...
        for (int k = 0; k < 3; k++)
        {
            ...
            {
                output.Write("<td bgcolor='#FFFFFF' onClick=Style(this,'#0000ff','#FFFFFF') style='color:#FFFFFF; cursor:pointer' ><strong>");
                output.Write(num7.ToString() + "</strong></td>");
            }
        }
        for (int m = 1; m < 13; m++)
        {
        ...
        for (int n = 0; n < 3; n++)
        {
            ...
            for (int num11 = 0; num11 < 10; num11++)
            {
                ...
                output.Write(num11.ToString() + "</strong></td>");
            }
        }
        ...
        for (int num15 = 1; num15 < 13; num15++)
        {
            output.Write("<td bgcolor='#f7f7f7' height='28px'>");
