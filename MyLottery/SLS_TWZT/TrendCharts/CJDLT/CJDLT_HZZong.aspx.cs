...
public partial class CJDLT_CJDLT_HZZong : Page, IRequiresSessionState
{
    ...
    {
        this.GridView1.DataSource = BLL.CJDLT_HZZhong_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.CJDLT_HZZhong_SeleteByNum(100);
    ...
    {
        DataTable table = BLL.CJDLT_HZZhong_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
    }
    ...
    {
        DataTable table = BLL.CJDLT_HZZhong_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
    }
    ...
    {
        DataTable table = BLL.CJDLT_HZZhong_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
    }
    ...
    {
        DataTable table = BLL.CJDLT_HZZhong_SeleteByNum(10);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
    }
}
