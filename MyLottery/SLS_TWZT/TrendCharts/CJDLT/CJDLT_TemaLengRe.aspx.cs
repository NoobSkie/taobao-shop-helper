...
public partial class CJDLT_CJDLT_TemaLengRe : Page, IRequiresSessionState
{
    ...
    protected void GridView2Bind()
    {
        ...
        table = BLL.CJDLT_lengrejj_SeleteByNum(30);
    ...
    {
        DataTable table = new DataTable();
        table = BLL.CJDLT_lengre_SeleteByNum(30);
    ...
    {
        DataTable table = BLL.CJDLT_lengre_SeleteByNum(100);
        DataTable table2 = BLL.CJDLT_lengrejj_SeleteByNum(100);
    ...
    {
        DataTable table = BLL.CJDLT_lengre_SeleteByNum(50);
        DataTable table2 = new DataTable();
        table2 = BLL.CJDLT_lengrejj_SeleteByNum(50);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        DataTable table3 = new DataTable();
    ...
    {
        DataTable table = BLL.CJDLT_lengre_SeleteByNum(30);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        DataTable table2 = new DataTable();
        table2 = BLL.CJDLT_lengrejj_SeleteByNum(30);
        DataTable table3 = new DataTable();
        table3.Columns.Add("num", typeof(string));
        DataRow row = table3.NewRow();
        row[0] = "12";
    ...
    {
        DataTable table = BLL.CJDLT_lengre_SeleteByNum(20);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        DataTable table2 = new DataTable();
        table2 = BLL.CJDLT_lengrejj_SeleteByNum(20);
        DataTable table3 = new DataTable();
        table3.Columns.Add("num", typeof(string));
        DataRow row = table3.NewRow();
        row[0] = "12";
    ...
    {
        DataTable table = BLL.CJDLT_lengre_SeleteByNum(10);
        this.GridView1.DataSource = table;
        this.GridView1.DataBind();
        DataTable table2 = new DataTable();
        table2 = BLL.CJDLT_lengrejj_SeleteByNum(10);
        DataTable table3 = new DataTable();
        table3.Columns.Add("num", typeof(string));
        DataRow row = table3.NewRow();
        row[0] = "12";
