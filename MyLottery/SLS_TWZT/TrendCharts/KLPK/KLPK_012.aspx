<%@ page language="C#" autoeventwireup="true" CodeFile="~/TrendCharts/KLPK/KLPK_012.aspx.cs" inherits="KLPK_KLPK_012" enableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>快乐扑克开奖号码012路分布图</title>
    <style type="text/css">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="G_4" HeaderText="G_4" >
                                                  <ItemStyle Width="16px" BackColor="#C1E7FF"/>
                                                   ...
                                                   <asp:BoundField DataField="G_S_0" HeaderText="G_S_0" >
                                                  <ItemStyle Width="30px" BackColor="#00FF80"/>
                                                </asp:BoundField>
                                                 <asp:BoundField DataField="G_S_1" HeaderText="G_S_1" >
                                                  <ItemStyle Width="30px" BackColor="#00FF80"/>
                                                </asp:BoundField>
                                                 <asp:BoundField DataField="G_S_2" HeaderText="G_S_2" >
                                                  <ItemStyle Width="30px" BackColor="#00FF80"/>
                                                </asp:BoundField>
                                            </Columns>
                                        </asp:GridView>
