<%@ page language="C#" autoeventwireup="true" CodeFile="~/TrendCharts/KLPK/KLPK_DX.aspx.cs" inherits="KLPK_KLPK_DX" enableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>快乐扑克开奖号码大小分布图</title>
    <style type="text/css">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" UseAccessibleHeader="False" ShowFooter="True" Width="100%" bordercolorlight="#808080" bordercolordark="#FFFFFF"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="G_4" HeaderText="G_4" >
                                                  ...
                                                  <ItemStyle Width="20px" BackColor="#00FF80"/>
                                                </asp:BoundField>
                                            </Columns>
                                        </asp:GridView>
                                    </td>
