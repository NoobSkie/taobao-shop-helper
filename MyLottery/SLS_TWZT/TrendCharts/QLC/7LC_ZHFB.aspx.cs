...
public partial class Home_TrendCharts_7LC_7LC_ZHFB : TrendChartPageBase, IRequiresSessionState
{
    ...
    private void BindDataForAD()
    {
        ...
        DataRow[] rowArray = cacheAsDataTable.Select("LotteryID=13 and [Name] = '广告一'", "[Order]");
        DataRow[] rowArray2 = cacheAsDataTable.Select("LotteryID=13 and [Name] = '广告二'", "[Order]");
        DataRow[] rowArray3 = cacheAsDataTable.Select("LotteryID=13 and [Name] = '广告三'", "[Order]");
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            table = new TrendChart().LC7_ZHFB_Select(0, this.tb1.Text.ToString(), this.tb2.Text.ToString(), ref result);
    ...
    protected void btnTop100_Click(object sender, EventArgs e)
    {
        ...
        table = new TrendChart().LC7_ZHFB_Select(100, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop30_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().LC7_ZHFB_Select(30, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void btnTop50_Click(object sender, EventArgs e)
    {
        string result = "";
        DataTable table = new DataTable();
        table = new TrendChart().LC7_ZHFB_Select(50, "", "", ref result);
        if ((table != null) && (table.Rows.Count >= 1))
        {
            int count = table.Rows.Count;
            this.tb1.Text = table.Rows[0]["Isuse"].ToString();
    ...
    protected void ColorBind()
    {
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            ...
            if (this.GridView1.Rows[i].Cells[0x21].Text == "Blue|0")
            {
                this.GridView1.Rows[i].Cells[0x21].Text = "0";
                this.GridView1.Rows[i].Cells[0x21].ForeColor = Color.FromArgb(0, 0, 0xff);
            }
            if (this.GridView1.Rows[i].Cells[0x21].Text == "Red|0")
            {
                this.GridView1.Rows[i].Cells[0x21].Text = "0";
                this.GridView1.Rows[i].Cells[0x21].ForeColor = Color.FromArgb(0xff, 0, 0);
            }
            if (this.GridView1.Rows[i].Cells[0x22].Text == "Blue|1")
            {
                this.GridView1.Rows[i].Cells[0x22].Text = "1";
                this.GridView1.Rows[i].Cells[0x22].ForeColor = Color.FromArgb(0, 0, 0xff);
            }
            if (this.GridView1.Rows[i].Cells[0x22].Text == "Red|1")
            {
                this.GridView1.Rows[i].Cells[0x22].Text = "1";
                this.GridView1.Rows[i].Cells[0x22].ForeColor = Color.FromArgb(0xff, 0, 0);
            }
            if (this.GridView1.Rows[i].Cells[0x23].Text == "Blue|2")
            {
                this.GridView1.Rows[i].Cells[0x23].Text = "2";
                this.GridView1.Rows[i].Cells[0x23].ForeColor = Color.FromArgb(0, 0, 0xff);
            }
            if (this.GridView1.Rows[i].Cells[0x23].Text == "Red|2")
            {
                this.GridView1.Rows[i].Cells[0x23].Text = "2";
                this.GridView1.Rows[i].Cells[0x23].ForeColor = Color.FromArgb(0xff, 0, 0);
            }
            if (this.GridView1.Rows[i].Cells[0x24].Text == "Blue|3")
            {
                this.GridView1.Rows[i].Cells[0x24].Text = "3";
                this.GridView1.Rows[i].Cells[0x24].ForeColor = Color.FromArgb(0, 0, 0xff);
            }
            if (this.GridView1.Rows[i].Cells[0x24].Text == "Red|3")
            {
                this.GridView1.Rows[i].Cells[0x24].Text = "3";
                this.GridView1.Rows[i].Cells[0x24].ForeColor = Color.FromArgb(0xff, 0, 0);
            }
            if (this.GridView1.Rows[i].Cells[0x25].Text == "Blue|4")
            {
                this.GridView1.Rows[i].Cells[0x25].Text = "4";
                this.GridView1.Rows[i].Cells[0x25].ForeColor = Color.FromArgb(0, 0, 0xff);
            }
            if (this.GridView1.Rows[i].Cells[0x25].Text == "Red|4")
            {
                this.GridView1.Rows[i].Cells[0x25].Text = "4";
                this.GridView1.Rows[i].Cells[0x25].ForeColor = Color.FromArgb(0xff, 0, 0);
            }
            if (this.GridView1.Rows[i].Cells[0x26].Text == "Blue|5")
            {
                this.GridView1.Rows[i].Cells[0x26].Text = "5";
                this.GridView1.Rows[i].Cells[0x26].ForeColor = Color.FromArgb(0, 0, 0xff);
            }
            if (this.GridView1.Rows[i].Cells[0x26].Text == "Red|5")
            {
                this.GridView1.Rows[i].Cells[0x26].Text = "5";
                this.GridView1.Rows[i].Cells[0x26].ForeColor = Color.FromArgb(0xff, 0, 0);
            }
            if (this.GridView1.Rows[i].Cells[0x27].Text == "Blue|6")
            {
                this.GridView1.Rows[i].Cells[0x27].Text = "6";
                this.GridView1.Rows[i].Cells[0x27].ForeColor = Color.FromArgb(0, 0, 0xff);
            }
            if (this.GridView1.Rows[i].Cells[0x27].Text == "Red|6")
            {
                this.GridView1.Rows[i].Cells[0x27].Text = "6";
                this.GridView1.Rows[i].Cells[0x27].ForeColor = Color.FromArgb(0xff, 0, 0);
            }
            if (this.GridView1.Rows[i].Cells[40].Text == "Blue|7")
            {
                this.GridView1.Rows[i].Cells[40].Text = "7";
                this.GridView1.Rows[i].Cells[40].ForeColor = Color.FromArgb(0, 0, 0xff);
            }
            if (this.GridView1.Rows[i].Cells[40].Text == "Red|7")
            {
                this.GridView1.Rows[i].Cells[40].Text = "7";
                this.GridView1.Rows[i].Cells[40].ForeColor = Color.FromArgb(0xff, 0, 0);
            }
            if (this.GridView1.Rows[i].Cells[0x29].Text == "Blue|8")
            {
                this.GridView1.Rows[i].Cells[0x29].Text = "8";
                this.GridView1.Rows[i].Cells[0x29].ForeColor = Color.FromArgb(0, 0, 0xff);
            }
            if (this.GridView1.Rows[i].Cells[0x29].Text == "Red|8")
            {
                this.GridView1.Rows[i].Cells[0x29].Text = "8";
                this.GridView1.Rows[i].Cells[0x29].ForeColor = Color.FromArgb(0xff, 0, 0);
            }
            if (this.GridView1.Rows[i].Cells[0x2a].Text == "Blue|9")
            {
                this.GridView1.Rows[i].Cells[0x2a].Text = "9";
                this.GridView1.Rows[i].Cells[0x2a].ForeColor = Color.FromArgb(0, 0, 0xff);
            }
            if (this.GridView1.Rows[i].Cells[0x2a].Text == "Red|9")
            {
                this.GridView1.Rows[i].Cells[0x2a].Text = "9";
                this.GridView1.Rows[i].Cells[0x2a].ForeColor = Color.FromArgb(0xff, 0, 0);
            }
            for (int k = 1; k < 10; k++)
            {
                if (_Convert.StrToInt(this.GridView1.Rows[i].Cells[k].Text, -1) == 0)
                {
                    this.GridView1.Rows[i].Cells[k].Text = "0" + k.ToString();
                    this.GridView1.Rows[i].Cells[k].ForeColor = Color.FromArgb(0xff, 0, 0);
                    this.GridView1.Rows[i].Cells[k].Font.Bold = true;
                }
            }
            for (int m = 10; m < 0x1f; m++)
            {
                if (_Convert.StrToInt(this.GridView1.Rows[i].Cells[m].Text, -1) == 0)
                {
                    this.GridView1.Rows[i].Cells[m].Text = m.ToString();
            ...
            for (int n = 1; n < 10; n++)
            {
                if (_Convert.StrToInt(this.GridView1.DataKeys[i].Value.ToString(), 0) == n)
                {
                    this.GridView1.Rows[i].Cells[n].Text = "0" + n.ToString();
                    this.GridView1.Rows[i].Cells[n].ForeColor = Color.FromArgb(0, 0, 0xff);
                }
            }
            for (int num6 = 10; num6 < 0x1f; num6++)
            {
                if (_Convert.StrToInt(this.GridView1.DataKeys[i].Value.ToString(), 0) == num6)
                {
                    this.GridView1.Rows[i].Cells[num6].Text = num6.ToString();
                    this.GridView1.Rows[i].Cells[num6].ForeColor = Color.FromArgb(0, 0, 0xff);
                }
            }
        }
    }
    ...
    protected void DrawGridFooter(HtmlTextWriter output, Control ctl)
    {
        ...
        for (int num8 = 10; num8 < 0x1f; num8++)
        {
            output.Write("<td bgcolor='#FFFFFF' onClick=Style(this,'#ff0000','#FFFFFF') style='color:#FFFFFF;' ><strong>");
        ...
        for (int num11 = 10; num11 < 0x1f; num11++)
        {
