...
using TOPFacade = TOP.Core.Facade;
using TOP.Applications.TaobaoShopHelper._Common;
using LocalFacade = TOP.Management.Facade;
using System.Text;
...
namespace TOP.Applications.TaobaoShopHelper.ShopHelper
{
    public partial class AddItem : BasePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            TOPFacade.ItemFacade itemFacade = new TOPFacade.ItemFacade(varHelper.TOP_AppKey, varHelper.TOP_AppSecret);
