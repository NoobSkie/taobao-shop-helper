...
namespace TOP.Applications.TaobaoShopHelper
{
    public partial class TestPage : BasePage
    {
        ...
        protected void btnGetItemDetail_Click(object sender, EventArgs e)
        {
            ...
            ItemFacade areaFacade = new ItemFacade(varHelper.TOP_AppKey, varHelper.TOP_AppSecret);
        ...
        {
            ProductFacade productFacade = new ProductFacade(varHelper.TOP_AppKey, varHelper.TOP_AppSecret);
