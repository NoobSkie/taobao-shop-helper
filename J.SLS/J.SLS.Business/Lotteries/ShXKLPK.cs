...
{
    internal class ShXKLPK : LotteryBase
    {
        ...
        {
            return new PlayType[] { new PlayType(0x1644, "混合投注"), new PlayType(0x1645, "任选一单式"), new PlayType(0x1646, "任选一复式"), new PlayType(0x1647, "任选二单式"), new PlayType(0x1648, "任选二复式"), new PlayType(0x1649, "任选三单式"), new PlayType(0x164a, "任选三复式"), new PlayType(0x164b, "选四组选24"), new PlayType(0x164c, "选四组选12"), new PlayType(0x164d, "选四组选6"), new PlayType(0x164e, "选四组选4"), new PlayType(0x164f, "选四直选单式"), new PlayType(0x1650, "选四组选复式") };
        }
