...
{
    internal class SDKLPK : LotteryBase
    {
        ...
        {
            return new PlayType[] { new PlayType(0x1324, "混合投注"), new PlayType(0x1325, "任选一单式"), new PlayType(0x1326, "任选一复式"), new PlayType(0x1327, "任选二单式"), new PlayType(0x1328, "任选二复式"), new PlayType(0x1329, "任选三单式"), new PlayType(0x132a, "任选三复式"), new PlayType(0x132b, "选四组选24"), new PlayType(0x132c, "选四组选12"), new PlayType(0x132d, "选四组选6"), new PlayType(0x132e, "选四组选4"), new PlayType(0x132f, "选四直选单式"), new PlayType(0x1330, "选四组选复式") };
        }
