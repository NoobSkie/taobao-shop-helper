            ...
            for (int i = 1; i < (num + 1); i++)
            {
                ...
                else
                {
                    for (int n = 0; n < strArray.Length; n++)
                    {
                        ...
                        Money += num3 * multiple;
                        list.Add(new Ticket(0x67, this.ConvertFormatToElectronTicket_HPJX(PlayTypeID, str2), multiple, num3 * multiple));
                    }
                }
            }
            Ticket[] ticketArray = new Ticket[list.Count];
            ...
            for (int i = 1; i < (num + 1); i++)
            {
                ...
                else
                {
                    for (int n = 0; n < strArray.Length; n++)
                    {
                        ...
                        num3 += 2.0 * double.Parse(strArray[n].ToString().Split(new char[] { '|' })[1]);
                        Money += num3 * multiple;
                        list.Add(new Ticket(0x66, this.ConvertFormatToElectronTicket_HPJX(PlayTypeID, str2), multiple, num3 * multiple));
                    }
                }
            }
            Ticket[] ticketArray = new Ticket[list.Count];
            ...
            for (int i = 1; i < (num + 1); i++)
            {
                ...
                else
                {
                    for (int n = 0; n < strArray.Length; n++)
                    {
                        ...
                        num3 += 2.0 * double.Parse(strArray[n].ToString().Split(new char[] { '|' })[1]);
                        Money += num3 * multiple;
                        list.Add(new Ticket(0x67, this.ConvertFormatToElectronTicket_HPSH(PlayTypeID, str2), multiple, num3 * multiple));
                    }
                }
            }
            Ticket[] ticketArray = new Ticket[list.Count];
            ...
            for (int i = 1; i < (num + 1); i++)
            {
                ...
                else
                {
                    for (int n = 0; n < strArray.Length; n++)
                    {
                        ...
                        num3 += 2.0 * double.Parse(strArray[n].ToString().Split(new char[] { '|' })[1]);
                        Money += num3 * multiple;
                        list.Add(new Ticket(0x66, this.ConvertFormatToElectronTicket_HPSH(PlayTypeID, str2), multiple, num3 * multiple));
                    }
                }
            }
            Ticket[] ticketArray = new Ticket[list.Count];
