...
namespace J.SLS.Business
{
    internal class TCCJDLT : LotteryBase
    {
        ...
        private JTicket[] ToElectronicTicket_DYJ_2_D(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
        {
            ...
            for (int i = 1; i < (num + 1); i++)
            {
                ...
                for (int k = 0; k < strArray.Length; k += 5)
                {
                    ...
                    Money += num3 * multiple;
                    list.Add(new JTicket(0x69, this.ConvertFormatToElectronTicket_DYJ(PlayTypeID, number), multiple, num3 * multiple));
                }
            }
        ...
        private JTicket[] ToElectronicTicket_DYJ_2_F(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
        {
            string[] strArray = this.AnalyseScheme(Number, PlayTypeID).Split(new char[] { '\n' });
            if (strArray == null)
            {
        ...
        private JTicket[] ToElectronicTicket_DYJ_ZJ_D(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
        {
            string[] strArray = this.AnalyseScheme(Number, PlayTypeID).Split(new char[] { '\n' });
            if (strArray == null)
            {
        ...
        private JTicket[] ToElectronicTicket_DYJ_ZJ_F(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
        {
            string[] strArray = this.AnalyseScheme(Number, PlayTypeID).Split(new char[] { '\n' });
            if (strArray == null)
            {
        ...
        private JTicket[] ToElectronicTicket_HPSD_2_D(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
        {
            string[] strArray = this.AnalyseScheme(Number, PlayTypeID).Split(new char[] { '\n' });
            if (strArray == null)
            {
        ...
        private JTicket[] ToElectronicTicket_HPSD_ZJ_D(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
        {
            string[] strArray = this.AnalyseScheme(Number, PlayTypeID).Split(new char[] { '\n' });
            if (strArray == null)
            {
        ...
        private JTicket[] ToElectronicTicket_HPSD_ZJ_F(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
        {
            string[] strArray = this.AnalyseScheme(Number, PlayTypeID).Split(new char[] { '\n' });
            if (strArray == null)
            {
