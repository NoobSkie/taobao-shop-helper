...
{
    internal class HBKLPK : LotteryBase
    {
        ...
        {
            return new PlayType[] { new PlayType(0x12c0, "混合投注"), new PlayType(0x12c1, "任选一单式"), new PlayType(0x12c2, "任选一复式"), new PlayType(0x12c3, "任选二单式"), new PlayType(0x12c4, "任选二复式"), new PlayType(0x12c5, "任选三单式"), new PlayType(0x12c6, "任选三复式"), new PlayType(0x12c7, "选四组选24"), new PlayType(0x12c8, "选四组选12"), new PlayType(0x12c9, "选四组选6"), new PlayType(0x12ca, "选四组选4"), new PlayType(0x12cb, "选四直选单式"), new PlayType(0x12cc, "选四组选复式") };
        }
