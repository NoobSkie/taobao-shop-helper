...
{
    internal class LLKLPK : LotteryBase
    {
        ...
        {
            return new PlayType[] { new PlayType(0x14b4, "混合投注"), new PlayType(0x14b5, "任选一单式"), new PlayType(0x14b6, "任选一复式"), new PlayType(0x14b7, "任选二单式"), new PlayType(0x14b8, "任选二复式"), new PlayType(0x14b9, "任选三单式"), new PlayType(0x14ba, "任选三复式"), new PlayType(0x14bb, "选四组选24"), new PlayType(0x14bc, "选四组选12"), new PlayType(0x14bd, "选四组选6"), new PlayType(0x14be, "选四组选4"), new PlayType(0x14bf, "选四直选单式"), new PlayType(0x14c0, "选四组选复式") };
        }
