...
{
    internal class ZJKLPK : LotteryBase
    {
        ...
        {
            return new PlayType[] { new PlayType(0x157c, "混合投注"), new PlayType(0x157d, "任选一单式"), new PlayType(0x157e, "任选一复式"), new PlayType(0x157f, "任选二单式"), new PlayType(0x1580, "任选二复式"), new PlayType(0x1581, "任选三单式"), new PlayType(0x1582, "任选三复式"), new PlayType(0x1583, "选四组选24"), new PlayType(0x1584, "选四组选12"), new PlayType(0x1585, "选四组选6"), new PlayType(0x1586, "选四组选4"), new PlayType(0x1587, "选四直选单式"), new PlayType(0x1588, "选四组选复式") };
        }
