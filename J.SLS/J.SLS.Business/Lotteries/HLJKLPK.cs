...
{
    internal class HLJKLPK : LotteryBase
    {
        ...
        {
            return new PlayType[] { new PlayType(0x1450, "混合投注"), new PlayType(0x1451, "任选一单式"), new PlayType(0x1452, "任选一复式"), new PlayType(0x1453, "任选二单式"), new PlayType(0x1454, "任选二复式"), new PlayType(0x1455, "任选三单式"), new PlayType(0x1456, "任选三复式"), new PlayType(0x1457, "选四组选24"), new PlayType(0x1458, "选四组选12"), new PlayType(0x1459, "选四组选6"), new PlayType(0x145a, "选四组选4"), new PlayType(0x145b, "选四直选单式"), new PlayType(0x145c, "选四组选复式") };
        }
