...
{
    internal class AHKLPK : LotteryBase
    {
        ...
        {
            return new PlayType[] { new PlayType(0x13ec, "混合投注"), new PlayType(0x13ed, "任选一单式"), new PlayType(0x13ee, "任选一复式"), new PlayType(0x13ef, "任选二单式"), new PlayType(0x13f0, "任选二复式"), new PlayType(0x13f1, "任选三单式"), new PlayType(0x13f2, "任选三复式"), new PlayType(0x13f3, "选四组选24"), new PlayType(0x13f4, "选四组选12"), new PlayType(0x13f5, "选四组选6"), new PlayType(0x13f6, "选四组选4"), new PlayType(0x13f7, "选四直选单式"), new PlayType(0x13f8, "选四组选复式") };
        }
