...
{
    internal class SCKLPK : LotteryBase
    {
        ...
        {
            return new PlayType[] { new PlayType(0x15e0, "混合投注"), new PlayType(0x15e1, "任选一单式"), new PlayType(0x15e2, "任选一复式"), new PlayType(0x15e3, "任选二单式"), new PlayType(0x15e4, "任选二复式"), new PlayType(0x15e5, "任选三单式"), new PlayType(0x15e6, "任选三复式"), new PlayType(0x15e7, "选四组选24"), new PlayType(0x15e8, "选四组选12"), new PlayType(0x15e9, "选四组选6"), new PlayType(0x15ea, "选四组选4"), new PlayType(0x15eb, "选四直选单式"), new PlayType(0x15ec, "选四组选复式") };
        }
