...
{
    internal class HeBKLPK : LotteryBase
    {
        ...
        {
            return new PlayType[] { new PlayType(0x1388, "混合投注"), new PlayType(0x1389, "任选一单式"), new PlayType(0x138a, "任选一复式"), new PlayType(0x138b, "任选二单式"), new PlayType(0x138c, "任选二复式"), new PlayType(0x138d, "任选三单式"), new PlayType(0x138e, "任选三复式"), new PlayType(0x138f, "选四组选24"), new PlayType(0x1390, "选四组选12"), new PlayType(0x1391, "选四组选6"), new PlayType(0x1392, "选四组选4"), new PlayType(0x1393, "选四直选单式"), new PlayType(0x1394, "选四组选复式") };
        }
