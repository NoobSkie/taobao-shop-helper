...
function GetAddone_callback(response) {
    ...
    if (response == null || response.value == null) {
        ...
        time_GetAddone = setTimeout("Lottery_Buy_SFC.GetAddone(" + currentLotteryID + "," + currentLotteryID + ",GetAddone_callback);", 2000);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SFC.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function btn_OK() {
    ...
    try {
        var LotteryNumber = Lottery_Buy_SFC.AnalyseScheme(document.getElementById("tbLotteryNumbers").value, document.getElementById('HidLotteryID').value, document.getElementById('tbPlayTypeID').value);
